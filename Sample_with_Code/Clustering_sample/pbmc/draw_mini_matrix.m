...
count_=readtable(['D:/A Novel Neural Network by Topological Dynamic Space Transform Method/KAILIN/Database/造血准备重排-matlab.csv']);
...
%writetable(count_result_out,'predict.csv')