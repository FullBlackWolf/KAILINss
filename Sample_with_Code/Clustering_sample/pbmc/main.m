...
MM0 = load('data/pbmc-similarity_matrix.mat');
count_=readtable('data/pbmc_matlab_input.csv');
MM0 = MM0.similarity_matrix;
%MM0=matrix;
% 是否去除prog
...
writetable(count_result_out,'result/pbmc_predict.csv')