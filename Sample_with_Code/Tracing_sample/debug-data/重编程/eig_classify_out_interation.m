...
MM0 = load('D:/A Novel Neural Network by Topological Dynamic Space Transform Method/KAILIN/Github/part4 绘制小图/重编程（只测prog）/similarity_matrix_sb_wsw.mat');
count_=readtable('D:/A Novel Neural Network by Topological Dynamic Space Transform Method/KAILIN/Github/part4 绘制小图/重编程（只测prog）/wsw_pandas_label.xlsx');
...
for left=1:step:length(MM);
    ...
    sp=eig_classify(MM(left:right,left:right),false,false,false,5);
...
writetable(count_result,'D:/A Novel Neural Network by Topological Dynamic Space Transform Method/KAILIN/Github/part4 绘制小图/重编程（只测prog）/chensresult.csv')
...
%% 划分矩阵块 lyw
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%split_simple需要自己划
split_simple=[1 123 288 375 529 654 673 862 903 1004 1164 1560 1741];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
